...
const COUVERTURE_PATH = asset_url("/images/background_logo_p24.png");
const COUVERTURE_PATH_XS = asset_url("/images/background_no_logo_p24.jpeg");
const LOGO_PATH = asset_url("/images/logo_p24.png");
          ...
          <Hidden smUp implementation="css">
            <div className={classes.couvXS}>
              <img
                alt="logo_pic"
                src={LOGO_PATH}
                className={classes.logoCouv}
              />
              <img
                alt="couverture_pic"
                src={COUVERTURE_PATH_XS}
