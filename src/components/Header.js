...
const COUVERTURE_PATH = asset_url('/images/background_logo_a23.jpeg')
const COUVERTURE_PATH_XS = asset_url('/images/Fond_P24.jpeg')
const LOGO_PATH = asset_url('/images/lLogo_P24.png')
